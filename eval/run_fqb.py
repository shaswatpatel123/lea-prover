...
def verify_proof(proof_path: Path, problem_name: str) -> tuple[bool, str]:
    """SafeVerify against Main.lean: kernel replay + decl match + axiom whitelist.

    Tactic-query tokens (`exact?` etc.) are checked separately because
    they are elaborated away before the .olean and SafeVerify can't see them."""
